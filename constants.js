...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: "Production-ready real-time collaborative whiteboard with live cursors",
    ...
    featured: true,
    status: "live",
    image: "/projects/collabboard.svg",
    overview:
      "CollabBoard is a production-ready collaborative whiteboard web app for drawing, annotating, and brainstorming together on an infinite canvas. It combines Liveblocks real-time storage and presence with Fabric.js canvas tooling, Supabase persistence, and OAuth authentication for a polished multi-user workspace.",
    achievements: [
      "Built real-time collaboration with Liveblocks rooms, shared storage, live cursors, selected objects, and deterministic user colors",
      "Implemented 11 canvas tools including select, hand, pen, shapes, arrow, line, text, sticky note, image, and eraser",
      "Added dashboard workflows for creating, renaming, deleting, organizing, and sharing boards with view/edit permissions",
      "Shipped power-user features including undo/redo, 10%-500% zoom, PNG/JSON/SVG export, keyboard shortcuts, grid toggle, and connection status badges",
    ],
    timeline: [
    ...
    techStack: ["Next.js App Router", "TypeScript", "Tailwind CSS", "Liveblocks", "Fabric.js", "Supabase", "NextAuth v5", "Zustand", "Framer Motion"],
...
export const ABOUT = {
  ...
  stats: [
    ...
    { label: "Play Store Downloads", value: 100, suffix: "+" },
